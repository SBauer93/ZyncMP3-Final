...
# Create project
create_project -force $proj_name "rtl"
...
set ip_repos [list $essentials_dir/vivado-ip hls]
set_property "ip_repo_paths" $ip_repos $obj

update_ip_catalog

create_ip -name Filter -vendor xilinx.com -library hls -version 1.0 -module_name MP3
